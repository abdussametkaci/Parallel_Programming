/*
Modify ParGradDesc.c code performing following 3 tasks:

Apply Cartesian Topology
Write a suitable code to observe the efficacy of the Gradient Descent algorithm
